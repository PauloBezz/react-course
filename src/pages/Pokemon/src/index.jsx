  ...
  return (
    <>
      ...
      <article className="flex w-full h-screen flex-col items-center mt-10 text-center">
        ...
        <section className="flex flex-wrap p-2 flex-col-reverse gap-y-2 items-center bg-red-200 rounded">
          <h1 className="text-xl mb-4">Procure seu pokémon</h1>

          <div className="flex w-fit gap-4 flex-wrap justify-around">
            <input type="text" className="w-56 border-black border-2 rounded pl-1" onChange={(e) => setPokemon(e.target.value.toLowerCase())} />
            <button
